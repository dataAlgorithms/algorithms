...
def findCrossOver(arr, low, high, x):
    ...
    # If x is the same as middle element, then return mid
...
'''
Function prints k closest elements to x in arr
...
def printKclosest(arr, x, k, n):
    ...
    count = 0 # keep track of count of elements already printed
